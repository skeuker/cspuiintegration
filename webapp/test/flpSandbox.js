		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CSP UI Integration PoC",
									"targetURL": "#tchibob2ccspuiintegration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tchibob2ccspuiintegration-display": {
								"semanticObject": "tchibob2ccspuiintegration",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tchibo.b2c.cspuiintegration",
									"url": sap.ui.require.toUrl("tchibo/b2c/cspuiintegration")
								}
							}
						}
					}
